...
// validao dos campos obrigatorios
            if ((txtOsEquip.getText().isEmpty()) || (txtOsDef.getText().isEmpty()) || (txtCliId.getText().isEmpty()) || cboOsSit.getSelectedItem().equals(" ")) {
    ...
    private void pesquisar_os() {
        ...
        String sql = "select os, date_format(dataos, '%d/%m/%Y - %H:%i'), tipo,situacao,equipamento,defeito,servico,tecnico,valor,idcli from tbos where os= " + num_os;
        try {
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) { // (rs.next())  >> caso tenha um registro correspondente
                txtOs.setText(rs.getString(1));
                txtData.setText(rs.getString(2));
                // setando os radions buttons
...
// habilitar campos e reabilitar botoes e gerenciar botoes
...
// metodo para imprimir uma os
    ...
    private void imprimir_os() {
        ...
        if (confirma == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                filtro.put("os", Integer.parseInt(txtOs.getText())); // os foi o nome do paramatro dado no ireports
    ...
    private void menRelSerActionPerformed(java.awt.event.ActionEvent evt) {
        int confirma = JOptionPane.showConfirmDialog(null, "Confirma a emissão deste Relatórios?", "Atenção", JOptionPane.YES_NO_OPTION);
        if (confirma == JOptionPane.YES_OPTION) {
    ...
    private void initComponents() {
        ...
        btnAlterar.setToolTipText("Pesquisar");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnExcluir, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnAlterar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(39, 39, 39))
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(398, 398, 398)
